...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"Native/customButton.js":[function(require,module,exports) {
...
function (_HTMLButtonElement) {
  _inherits(CustomButton, _HTMLButtonElement);
  ...
  function CustomButton() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(CustomButton).call(this));

    _this.addEventListener('click', _this.callBack);
  ...
  _createClass(CustomButton, [{
    ...
    value: function callBack(e) {
      console.log("".concat(this.getAttribute('is'), " called"));
    }
  }]);
...
},{}],"Native/myInfo.js":[function(require,module,exports) {
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_HTMLElement) {
  ...
  function MyInfo() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MyInfo).call(this));
    _this.shadowElement = _this.attachShadow({
      mode: 'open'
    });
    return _this;
  }
  ...
  _createClass(MyInfo, [{
    ...
    value: function capitalize() {
      ...
      return value.split(' ').map(function (e) {
    ...
    value: function render() {
      var template = "\n      <span>".concat(this.capitalize(), "</span>\n    ");
...
},{}],"Native/countryInfo.js":[function(require,module,exports) {
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_HTMLElement) {
  ...
  function CountryInfo() {
    ...
    _this._country = _this.getAttribute('country');
    _this._countryInfo = {};
  ...
  _createClass(CountryInfo, [{
    ...
    key: "connectedCallback",
    value: function connectedCallback() {
      console.log("".concat(this.tagName, " mounted into the DOM"));
    }
  }, {
...
var button = document.querySelector('button#get-details');
...
},{}],"Native/index.js":[function(require,module,exports) {
"use strict";
